    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnsound1.setOnClickListener(new View.OnClickListener() {//niat
            ...
            public void onClick(View v) {
                ...
                mediaPlayer.release();
                mediaPlayer= MediaPlayer.create(asar.this, R.raw.bacaan1_niatasar);
                mediaPlayer.start();            }
        });
        ...
        btnsound2.setOnClickListener(new View.OnClickListener() {//butang takbir
            ...
            public void onClick(View v) {
                ...
                //mediaPlayer.release();
                mediaPlayer= MediaPlayer.create(asar.this, R.raw.bacaan2_takbir);
                mediaPlayer.start();
            }
        });
        ...
        btnsound3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mediaPlayer.release();
                mediaPlayer= MediaPlayer.create(asar.this, R.raw.bacaan3_iftitah);
                mediaPlayer.start();            }
        });
        ...
        btnsound.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mediaPlayer.release();
                mediaPlayer= MediaPlayer.create(asar.this, R.raw.bacaan1_alfatihah);
                mediaPlayer.start();            }
        });
        btnsound4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mediaPlayer.release();
                mediaPlayer= MediaPlayer.create(asar.this, R.raw.bacaan4_rukuk);
                mediaPlayer.start();
            }
        });
        ...
        btnsound5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mediaPlayer.release();
                mediaPlayer= MediaPlayer.create(asar.this, R.raw.bacaan5_iktidal);
                mediaPlayer.start();
        ...
        btnsound6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mediaPlayer.release();
                mediaPlayer= MediaPlayer.create(asar.this, R.raw.bacaan6_sujud);
                mediaPlayer.start();              }
        });
        ...
        btnsound7.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mediaPlayer.release();
                mediaPlayer= MediaPlayer.create(asar.this, R.raw.bacaan7_dudukads);
                mediaPlayer.start();              }
        });
        ...
        btnsound15.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mediaPlayer.release();
                mediaPlayer= MediaPlayer.create(asar.this, R.raw.bacaan8_tahiyatawal);
                mediaPlayer.start();
            }
        });
        ...
        btnsound28.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mediaPlayer.release();
                mediaPlayer= MediaPlayer.create(asar.this, R.raw.bacaan9_tahiyatakhir);
                mediaPlayer.start();              }
        });
        btnsound29.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mediaPlayer.release();
                mediaPlayer= MediaPlayer.create(asar.this, R.raw.bacaan_salam);
                mediaPlayer.start();              }
        });
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mediaPlayer.release();
                clicksound.start();
                Intent intent=new Intent(asar.this, MainActivity.class);
