...
public class subuh extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_subuh);
        ...
        btnsound1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mediaPlayer.release();
                mediaPlayer= MediaPlayer.create(subuh.this, R.raw.bacaan1_niatsubuh);
                mediaPlayer.start();            }
        });
        ...
        btnsound2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //mediaPlayer.release();
                mediaPlayer= MediaPlayer.create(subuh.this, R.raw.bacaan2_takbir);
                mediaPlayer.start();
            }
        });
        ...
        btnsound3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               rukun.setText(R.string.tviftitah);
                ...
                mediaPlayer.release();
                mediaPlayer= MediaPlayer.create(subuh.this, R.raw.bacaan3_iftitah);
                mediaPlayer.start();            }
        });
        ...
        btnsound.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mediaPlayer.release();
                mediaPlayer= MediaPlayer.create(subuh.this, R.raw.bacaan1_alfatihah);
                mediaPlayer.start();            }
        });
        btnsound4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mediaPlayer.release();
                mediaPlayer= MediaPlayer.create(subuh.this, R.raw.bacaan4_rukuk);
                mediaPlayer.start();
           }
        });
        ...
        btnsound5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mediaPlayer.release();
                mediaPlayer= MediaPlayer.create(subuh.this, R.raw.bacaan5_iktidal);
                mediaPlayer.start();
        ...
        btnsound6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mediaPlayer.release();
                mediaPlayer= MediaPlayer.create(subuh.this, R.raw.bacaan6_sujud);
                mediaPlayer.start();              }
        });
        ...
        btnsound7.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mediaPlayer.release();
                mediaPlayer= MediaPlayer.create(subuh.this, R.raw.bacaan7_dudukads);
                mediaPlayer.start();              }
        });
        ...
        btnsound11.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                showSlide.setImageResource(R.drawable.solat_doaqunut);
                bacaan.setText(R.string.qunut);
                rukun.setText(R.string.tvqunut);

                mediaPlayer.release();
                mediaPlayer= MediaPlayer.create(subuh.this, R.raw.bacaan10_qunut);
                mediaPlayer.start();              }
        });
        ...
        btnsound15.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mediaPlayer.release();
                mediaPlayer= MediaPlayer.create(subuh.this, R.raw.bacaan9_tahiyatakhir);
                mediaPlayer.start();
            }
        });
        btnsound16.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mediaPlayer.release();
                mediaPlayer= MediaPlayer.create(subuh.this, R.raw.bacaan_salam);
                mediaPlayer.start();              }
        });
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mediaPlayer.release();
                clicksound.start();
                Intent intent=new Intent(subuh.this, MainActivity.class);
