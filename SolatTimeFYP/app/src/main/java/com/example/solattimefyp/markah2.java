...
public class markah2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_markah2);
        ...
        tvmarkahtertinggi=findViewById(R.id.tvmarkahtertinggi);
        ...
        btnUlang.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                finish();
                Intent back = new Intent(getApplicationContext(), PermainanMini2.class);
                startActivity(back);
            }
        });
        ...
        btnhome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                finish();
                Intent back = new Intent(getApplicationContext(), menuUtamaPerempuan.class);
                startActivity(back);
