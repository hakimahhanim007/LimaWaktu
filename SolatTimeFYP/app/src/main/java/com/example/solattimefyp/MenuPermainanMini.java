...
public class MenuPermainanMini extends AppCompatActivity  {
    ...
    int gambar[] = new int[]{
            R.drawable.solat1_berdiritegak,
            R.drawable.solat2_takbir,
            R.drawable.solat3_alfatihah,
            R.drawable.solat4_rukuk,
            R.drawable.solat5_sujud,
            R.drawable.solat6_duduk_a_2sujud,
            R.drawable.solat6_tahiyat_awal,
            R.drawable.solat7_tahiyat_akhir,
            R.drawable.solat8_salam,
            R.drawable.solat1_berdiritegak
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_permainan_mini);
        ...
        btn_kembali.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent =new Intent(MenuPermainanMini.this,  menuUtama2.class);
        ...
        btnSelanjutnya.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (rbA.isChecked() || rbB.isChecked() || rbC.isChecked() || rbD.isChecked()){
                    ...
                    Toast.makeText(MenuPermainanMini.this, "Sila Pilih Jawapan!",Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
