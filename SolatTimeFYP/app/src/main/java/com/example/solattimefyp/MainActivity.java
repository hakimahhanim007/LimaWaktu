    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ib_home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                bunyi.start();
                Intent intent = new Intent(MainActivity.this, menuUtama2.class);
        ...
        btn_subuh.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                bunyi.start();
                Intent intent = new Intent(MainActivity.this, subuh.class);
                startActivity(intent);
                bunyi.stop();
        ...
        btn_zuhur.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                bunyi.start();
                Intent intent = new Intent(MainActivity.this, zohor.class);
                startActivity(intent);
                bunyi.stop();
        ...
        btn_asar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                bunyi.start();
                Intent intent = new Intent(MainActivity.this, asar.class);
                startActivity(intent);
                bunyi.stop();
        ...
        btn_magrib.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                bunyi.start();
                Intent intent = new Intent(MainActivity.this, magrib.class);
                startActivity(intent);
                bunyi.stop();
        ...
        btn_isyak.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                bunyi.start();
                Intent intent = new Intent(MainActivity.this, isyak.class);
                startActivity(intent);
                bunyi.stop();
